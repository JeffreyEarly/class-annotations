classdef CAMethodAnnotation < handle
    ...
    %
    % - Declaration: classdef CAMethodAnnotation < handle
    ...
    methods
        function self = CAMethodAnnotation(name,description,options)
            % create a new instance of CAMethodAnnotation
            %
            % Creates a new instance of CAMethodAnnotation with a name,
            ...
            % - Declaration: annotation = CAMethodAnnotation(name,description,options)
            ...
            % - Returns annotation: a new instance of CAMethodAnnotation
            arguments
